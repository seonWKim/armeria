...
Backoff backoffOnServerErrorOrTimeout = Backoff.of();
...
Armeria provides <type://Backoff#of()> that you might use by default. It is exactly the same as:
