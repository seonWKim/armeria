...
public class DefaultServerMetrics implements ServerMetrics {
    ...
    private final LongAdder pendingRequests;

    public DefaultServerMetrics() {
        this.pendingRequests = new LongAdder();
    }

    public DefaultServerMetrics(LongAdder pendingRequests) {
        this.pendingRequests = pendingRequests;
    }

    @Override
    public long pendingRequests() {
        return pendingRequests.sum();
    }
